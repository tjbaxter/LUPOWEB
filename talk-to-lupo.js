...
(function () {
  ...
  style.textContent = [
    ...
    "  padding: 11px 20px; border: 1px solid rgba(255, 255, 255, 0.10); border-radius: 999px;",
    "  background: rgba(18, 18, 22, 0.72);",
    "  -webkit-backdrop-filter: blur(24px) saturate(160%); backdrop-filter: blur(24px) saturate(160%);",
    "  color: rgba(255, 255, 255, 0.96); cursor: pointer;",
    "  font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', sans-serif;",
    "  font-size: 14px; font-weight: 500; letter-spacing: -0.015em;",
    "  box-shadow: 0 12px 36px rgba(0, 0, 0, 0.55), 0 2px 6px rgba(0, 0, 0, 0.30), inset 0 1px 0 rgba(255, 255, 255, 0.06);",
    "  transition: transform 0.25s cubic-bezier(0.25, 0.46, 0.45, 0.94), box-shadow 0.25s ease, background 0.25s ease, border-color 0.25s ease, opacity 0.3s ease;",
    "}",
    ".lupo-call-btn:hover:not(:disabled) { transform: translateY(-2px); background: rgba(26, 26, 32, 0.84); border-color: rgba(255, 255, 255, 0.16); box-shadow: 0 18px 44px rgba(0, 0, 0, 0.65), 0 3px 10px rgba(0, 0, 0, 0.40), inset 0 1px 0 rgba(255, 255, 255, 0.08); }",
    ...
    ".lupo-call-btn[data-state='connecting'] { background: rgba(26, 26, 32, 0.85); border-color: rgba(167, 139, 250, 0.32); cursor: wait; }",
    ".lupo-call-btn[data-state='in-call'] { background: linear-gradient(135deg, #dc2626 0%, #ef4444 100%); border-color: transparent; color: white; box-shadow: 0 8px 32px rgba(220, 38, 38, 0.45); }",
    ".lupo-call-btn[data-state='rate_limited'], .lupo-call-btn[data-state='unavailable'] { background: rgba(40, 40, 45, 0.78); border-color: rgba(255, 255, 255, 0.06); }",
    ".lupo-call-btn-icon {",
    ...
    ".lupo-call-btn[data-state='in-call'] .lupo-call-btn-icon { color: rgba(255, 255, 255, 0.98); }",
    ".lupo-call-consent {",
